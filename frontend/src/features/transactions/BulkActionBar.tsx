...
export function BulkActionBar({
  ...
  // Mirror TransactionForm's "Parent / Child" label so nested categories carry their parent
  // for context (the bare "· Child" form is ambiguous across same-named subcategories).
